...
If you dont trust the behaviour of the app, feel free ro check the code and report any issues. Also you can check the [windows installer](https://github.com/sPROFFEs/autoclicker/blob/with-installer-code/instalador.iss) and [linux installer](https://github.com/sPROFFEs/autoclicker/blob/with-installer-code/PyclickeRecorder_Linux_installer.sh) scripts to see how the app is installed.